    ...
    return(
        <>
            <div className="w-full h-full flex justify-center  items-center flex-col bg-black pb-10">
                ...
                <div className="h-full w-[90%] md:w-[80%] flex flex-wrap justify-between md:justify-around  text-white md:gap-[50px] gap-[20px] mt-5">
                    <div className="md:w-[190px] h-full ">
